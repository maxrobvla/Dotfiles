...
-- configure 4 space tab
vim.opt.tabstop = 4
vim.opt.softtabstop = 4
vim.opt.shiftwidth = 4
vim.opt.expandtab = true

-- detects and uses useful indentation
                    ...
                    --    https://github.com/rafamadriz/friendly-snippets
                    {
                        ...
                        config = function()
                            require('luasnip.loaders.from_vscode').lazy_load {
                                exclude = { 'tex', 'plaintex', 'latex' },
                            }
                            require('luasnip.loaders.from_snipmate').load { include = { 'plaintex', 'tex', 'latex' } }
                            -- require('luasnip.loaders.from_snipmate').load_standalone { path = '~/.config/nvim-kickstart/snippets/plaintex.snippets' }
                        end,
                    },
                },
            },
...
keys('n', '<leader>bp', vim.cmd.bprevious, { desc = '[p]revious' })
keys('n', '<leader>bc', vim.cmd.bdelete, { desc = '[c]lose' })
keys('n', '<leader>bw', vim.cmd.w, { desc = '[w]rite' })
